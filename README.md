👋 Hi, I am Alexander and I am a beginner PHP Laravel Backend developer. Looking for a job in this area to further develop in it. Difficulties and work are not frightening, ready to advance and learn. The below mentioned stack was taught on my own for about 3 months, later continued on a course. Commercial IT experience is available, but in a different field, to be more precise, I was a database administrator and system administrator. In the context of Laravel, I have experience in developing small projects, which you can see in my GitHub profile. I will be glad to discuss any conditions.

My stack:
PHP, Laravel, MySQL, GIT, Docker, Composer, Blade, HTML, CSS, JavaScript (jQuery), UnitTest, PSR, SOLID, MVC. 

Soft skills:
Understanding of technical language, open to learning new technologies and techniques, non-confrontational, teamwork, willingness to achieve goals, communication skills.
...
- Administered the site of the organization under the CMS "1C-Bitrix: Site Management": Placed news and other various kinds of information on the site. Optimized the work of the site by adding new sections and elements, improving navigation for users. For example, implemented a navigation system on the site to find the right sections by integrating the draw.io layout into the site.
